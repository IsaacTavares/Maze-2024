...
/* variables de prueba */
  ...
  int pos = 0;            // variable para la posion del servo de las victimas  
...
void pixyColores() {
  ...
  void grabar(){
    ...
    if (ab_grabar==1){  
        ...
        archivo.print("Var de pos: ");archivo.println(pos);
...
    que cuando detecte un color sé prendera un led correspondiente.
  - Se agrego la parte del kit de victimas con un servo de 180
