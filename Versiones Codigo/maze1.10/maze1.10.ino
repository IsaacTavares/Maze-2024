...
/* Variables de Duración de los Movimientos */
  ...
  int giros_ISF = 52;  // clclos para iniciar el giro en la inzquierda sin frente
...
/*  En esta versión 1.10

  - En esta versión, se modificó la inercia tras efectuar un giro a la izquierda. 
    Para que vaya hacia delante normal en vez de impulso. 
