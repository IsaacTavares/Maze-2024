...
  - En esta versión, se cambio la direccion y la configuracion de los servos,
    devido a que un servo dejo de girar y lo tubimos que cambiar,
    pero giraba en la direccion opuesta por lo cual volvimos a programar 

    En esta vercion se hizo un cambio grande junto con el funcionamiento de las victimas
