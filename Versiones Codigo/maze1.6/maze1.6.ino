...
/* Variables de Duración de los Movimientos */
  int imp = 25;        
  int giros_I = 14;    // ciclos para iniciar el giro a la izquierda 
  int giros_ISF = 56;  // clclos para iniciar el giro en la inzquierda sin frente
  int giros_D = 14;    // ciclos para iniciar el giro a la derecha    
...
/*
  ...
  - se ajustaron los valores de la velocidad 2 y 3 para que sean más lentos y
    se ajuste mejor a las paredes 

  - se agregó más pasos al giro en la ISF, 
    pero son demasiados mayores de los que usa el giro en U
