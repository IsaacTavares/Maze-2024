...
// angulo de inclinación  
  int anguloI = 0;
// variable para contar cuanto timpo esta en el color azul
  int contA = 0; 
// variable para contar cuanto timpo esta en el color blanco
  int contB = 0; 
// variable para activar y desactival la izquierda sin frente
  bool condicionISF = false;
//varibla para activar y desactivar las lecturas
  bool lecturas =  true;
...
/*
  -En esta vercion se agregaron mas comentarios 
  -Se agrego un delay para ver hasta donde da los giros con los pasos 
  -Se quito la funcion 
*/