...
/* Variables de Duración de los Movimientos */
  int imp = 25;        
  int giros_I = 15;    // ciclos para iniciar el giro a la izquierda 
  int giros_ISF = 28;  // clclos para iniciar el giro en la inzquierda sin frente
  int giros_D = 15;    // ciclos para iniciar el giro a la derecha    
  int giros_u = 41;    // ciclos para iniciar el giro en U       
...
/*
  ...
  -se quitaron variables que no se utilizaban 

  -se agregaron comentarios acerca de para qué sirven algunas variables 

  -se quitaron la velocidad 4 y -2 porque eran innecesarias 

  -se quito la función de la Rasp

  -se puso un contador para salir con pasos del giro 
